...
export function logger(): Logger {
  return {
    debug: vi.fn().mockImplementation((msg: string) => {
      console.debug(msg);
    }),
    info: vi.fn().mockImplementation((msg: string) => {
      console.info(msg);
    }),
    warn: vi.fn().mockImplementation((msg: string) => {
      console.warn(msg);
    }),
    error: vi.fn().mockImplementation((msg: string) => {
      console.error(msg);
    }),
  };
}
