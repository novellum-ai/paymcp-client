...
export function mockResourceServer(
  mock: FetchMock,
  baseUrl: string = "https://example.com",
  resourcePath: string = "/mcp",
  authServerUrl: string = DEFAULT_AUTHORIZATION_SERVER,
) {
  mock.route({
...
export function mockAuthorizationServer(
  mock: FetchMock,
  baseUrl: string = DEFAULT_AUTHORIZATION_SERVER,
  paymentRequests: { [key: string]: BigNumber } = {},
) {
